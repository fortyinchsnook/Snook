  ...
  return (
    <section className="page active">
      ...
      <div className="page-sub">
        Fill in what you've got — snook under 22" can't be logged, this board's for the ones
      ...
      <div className="form-card">
        ...
        <button className="submit-btn" disabled={!tier || !county || submitting} onClick={handleSubmit}>
